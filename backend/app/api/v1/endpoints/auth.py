...
async def github_login() -> RedirectResponse:
    ...
    if not settings.GITHUB_CLIENT_ID or settings.GITHUB_CLIENT_ID == "your_github_client_id":
        raise HTTPException(
            ...
            detail="GITHUB_CLIENT_ID is not configured in Render environment variables. Please set GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET to enable real GitHub sign-in."
        )
